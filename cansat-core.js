...
(function () {
  ...
  const MISSIONS = [
    ...
    { id: 'ruzgarli', startX: -225, name: 'Rüzgârlı Gün', difficulty: 'Orta', drop: 550,
    ...
    { id: 'tersruzgar', startX: 57, name: 'Ters Akıntı', difficulty: 'İleri', drop: 700,
    ...
    { id: 'firtina', startX: -231, name: 'Fırtına İnişi', difficulty: 'Uzman', drop: 800,
